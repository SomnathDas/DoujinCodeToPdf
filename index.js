...
async function getDoujin(id) {
    try {
        console.log('\x1b[41m%s\x1b[0m', `Welcome To 『 𝓓𝓸𝓾𝓳𝓲𝓷 𝓒𝓸𝓭𝓮 𝓣𝓸 𝓟𝓓𝓕 』|『 同人コードをPDFに 』`);
        console.log('\x1b[41m%s\x1b[0m', `        『 Created By Somnath Das, @samurai3247 [Instagram] 』`);
        console.log('\x1b[44m%s\x1b[0m', `Processing and Converting your Code, Please Wait, senpai uwu`);
